...
<body>
    <form action="<?= base_url('procesar_formulario') ?>" method="post" class="container mt-5" style="max-width: 600px; margin: auto; background-color: #e9edf6; padding: 20px; border-radius: 10px; border: 2px solid #002F59;">
