...
<body>
		...
		<div class="row">
			<div
				...
				<img
					...
					src="<?= !empty($firstBanner) ? base_url('rendicion_cuentas/img/' . $firstBanner) : base_url('/rendicion_cuentas/img/bannerstatic.jpg') ?>"
	...
	<script src="<?= RUTA_JS_CLIENT . 'dashboard.js' ?>"></script>
