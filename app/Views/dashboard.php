                ...
                <div class="col-12 py-3 px-5" style="background-color: #2E8ACB; color: #fff; backdrop-filter: blur(20px);">
                    ...
                    <div class="row gap-3 gap-md-0">
                        <div class="col-md-4 col-sm-12">
                            <div class="card text-dark w-md-1" style="max-height: 400px; max-height: 400px;">
            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="col-md-4 col-sm-12">
                    <div>
                        ...
                        <p>
                            Sede central: Av. Sáenz Peña N.º 2151 - Urb. Latina - Jose Leonardo Ortiz - Chiclayo - Lambayeque - Perú
                        </p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
