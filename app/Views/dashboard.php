            ...
            <div class="col-12 py-3 px-5 info-section">
                ...
                <div class="row gap-3 gap-md-0 info-cards my-4">
                    <div class="col-md-4 col-sm-12">
                        <div class="card text-dark w-md-1 info-card">
                            <div class="card-img-top d-flex justify-content-center align-items-center" style="min-height: 100px; max-height: 100px;">
                                <i class="fa-solid fa-people-group info-card-icon"></i>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card text-dark w-md-1 info-card">
                            <div class="card-img-top d-flex justify-content-center align-items-center" style="min-height: 100px; max-height: 100px;">
                                <i class="fa-solid fa-handshake info-card-icon"></i>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card text-dark w-md-1 info-card">
                            <div class="card-img-top d-flex justify-content-center align-items-center" style="min-height: 100px; max-height: 100px;">
                                <i class="fa-solid fa-clipboard-list-check info-card-icon"></i>
                            </div>
                            <div class="card-body">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-12 text-center">
                        ...
                        <a href="<?= base_url('form') ?>" class="btn text-white btn-lg px-4 rounded-pill register-btn btn-register-principal">
